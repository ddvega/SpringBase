package com.fjapi.springbase.config;

import com.fjapi.springbase.filter.JwtFilter;
import com.fjapi.springbase.service.UserService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .permitAll()
                .antMatchers("/genre/all")
                .permitAll()
                .antMatchers("/genre/id/*")
                .permitAll()
                .antMatchers("/user/*")
                .hasAuthority("admin")
                .anyRequest()
